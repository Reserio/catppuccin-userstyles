...
1. Fork the `Reserio/catppuccin-userstyles` repository.
...
4. Copy the contents of the [`template`](https://github.com/Reserio/catppuccin-userstyles/tree/main/template) folder into `styles/<name-of-website>`.
...
7. Raise a [pull request](https://github.com/Reserio/catppuccin-userstyles/compare), making sure to read and fill out the template properly. The title of your pull request should follow the format of `feat(<name-of-website>): init`.
